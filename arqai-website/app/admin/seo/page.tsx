    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">SEO Optimization Console</h1>
        ...
        {data && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-white rounded-md p-6 shadow-sm border border-gray-200">
              <div className="flex items-center gap-3">
                <div className={`w-12 h-12 rounded-md flex items-center justify-center ${getScoreColor(data.overview.averageScore)}`}>
            ...
            <div className="bg-white rounded-md p-6 shadow-sm border border-gray-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{data.overview.needsAttention}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-md p-6 shadow-sm border border-gray-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-500">Excellent SEO</p>
                  <p className="text-2xl font-bold text-gray-900">{data.overview.excellent}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-md p-6 mb-8 text-white">
          <h2 className="text-sm font-semibold mb-4 uppercase tracking-wide">SEO/AEO/GEO Best Practices</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <h3 className="text-sm font-medium mb-2 flex items-center gap-2">
                <span className="w-5 h-5 bg-white/20 rounded-full flex items-center justify-center text-xs">S</span>
                SEO (Search Engines)
              </h3>
            ...
            <div>
              <h3 className="text-sm font-medium mb-2 flex items-center gap-2">
                <span className="w-5 h-5 bg-white/20 rounded-full flex items-center justify-center text-xs">A</span>
                AEO (Answer Engines)
              </h3>
              <ul className="text-sm text-white/80 space-y-1">
            ...
            <div>
              <h3 className="text-sm font-medium mb-2 flex items-center gap-2">
                <span className="w-5 h-5 bg-white/20 rounded-full flex items-center justify-center text-xs">G</span>
                GEO (Generative AI)
              </h3>
              <ul className="text-sm text-white/80 space-y-1">
              ...
              <tbody className="divide-y divide-gray-200">
                {filteredContent.map(item => (
                  <tr key={`${item.type}-${item.id}`} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <span className="px-2 py-1 text-xs font-medium rounded-md bg-gray-100 text-gray-700 capitalize">
                        {item.type.replace("-", " ")}
                      </span>
                    </td>
                    <td className="px-6 py-4">
                      <span className={`inline-flex items-center justify-center w-12 h-8 text-sm font-bold rounded-md ${getScoreColor(item.score)}`}>
                        {item.score}
                      </span>
                    </td>
                    <td className="px-6 py-4">
