...
const useCases = [
  ...
  },
  {
    ...
    body: "AI that gives associates the right answer for the customer in front of them, drawn from your catalog, your policies, and your store ops.",
  },
];
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <h1 className="text-display-xl md:text-[clamp(2.5rem,5vw,4rem)] font-display leading-[1.1] text-text-bright mb-6">
                  AI for retail teams that compete on customer relationship.
                </h1>
              ...
              >
                <Image
                  src="/img/services/Retail-40-percent-Faster-Pricing-Ops-Without-Manual-Review.jpg"
