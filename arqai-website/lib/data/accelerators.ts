...
export const accelerators: Accelerator[] = [
  ...
  },
  {
    ...
    overview:
      "ArqLoyalty is a modern loyalty engine a retailer can adopt without migration risk. It runs in shadow alongside the incumbent system, processes the same transactions, and proves its numbers match penny-for-penny every day — then is promoted to run live on the customer's timeline, one capability at a time. It ships as a configurable accelerator rather than a bespoke build: your loyalty programs become configuration, it deploys on your existing lakehouse, and onboarding follows a repeatable migrate, prove-parity, cut-over playbook. Built from generic loyalty primitives, the same core serves fuel & convenience, hospitality, malls, and any loyalty operator — each vertical shipping as a thin pack of currencies, redemption types, event adapters, connectors, and starter templates on the shared engine.",
    capabilities: [
      {
        title: "Shadow-mode parallel run",
        body: "Runs beside your incumbent platform on the same live transactions, with zero impact on members or operations until you decide otherwise.",
      },
      {
        title: "Penny-for-penny parity proof",
        body: "Reconciles its points, tiers, and balances against the existing system every day and surfaces any discrepancy before cut-over.",
      },
      {
        title: "Capability-by-capability cut-over",
        body: "Promote one program, currency, or redemption type to live at a time — on your timeline — instead of a single high-risk migration.",
      },
      {
        title: "Programs as configuration",
        body: "Earn rules, tiers, currencies, and redemptions are configured, not custom-coded, so changes ship without a rebuild.",
      },
      {
        title: "Runs on your lakehouse",
        body: "Deploys on the data platform you already operate, keeping member and transaction data in your environment.",
      },
      {
        title: "Vertical packs on a shared core",
        body: "Fuel, hospitality, and mall programs each ship as a thin pack of currencies, adapters, connectors, and templates over the same engine.",
      },
    ],
    useCases: [
      {
        title: "Replace an aging loyalty platform",
        body: "Move off a legacy or end-of-life system without freezing the program or risking member balances.",
      },
      {
        title: "Consolidate multiple programs",
        body: "Bring fragmented programs and currencies onto one governed engine, proving parity for each before switching.",
      },
      {
        title: "Launch a new vertical program",
        body: "Stand up a fuel, hospitality, or mall program from a starter pack on the shared core.",
      },
    ],
    integrations: [
      "Lakehouse / data platform",
      "Incumbent loyalty system",
      "POS & transaction feeds",
      "Payment & fuel controllers",
      "CDP / customer data",
      "Event & connector adapters",
    ],
    pain:
      "Replacing a loyalty platform means touching member balances, points liability, and daily financial reconciliation — so teams freeze on aging systems rather than risk a big-bang migration that could break the program.",
    promise:
      "ArqLoyalty lets you adopt a modern engine without betting the business: it runs in shadow, proves penny-for-penny parity every day, and cuts over one capability at a time on your timeline.",
    proof:
      "Built from generic loyalty primitives with a vertical-agnostic safe-cutover wedge, delivered through a repeatable migrate, prove-parity, cut-over playbook rather than a one-off build.",
    rollout: [
      "Migrate the existing program into ArqLoyalty as configuration.",
      "Run in shadow on live transactions and prove penny-for-penny parity daily.",
      "Cut over capability by capability on the customer's timeline.",
      "Extend to new currencies, redemptions, or verticals from the shared core.",
    ],
    metrics: [
      { value: "0", label: "Migration risk at cut-over" },
      { value: "1:1", label: "Penny-for-penny parity proven daily" },
      { value: "Your", label: "Timeline, one capability at a time" },
    ],
    signals: [
      "Loyalty runs on a legacy or end-of-life platform",
      "A big-bang migration is seen as too risky to attempt",
      "Multiple programs and currencies need to be consolidated",
      "Finance needs daily reconciliation it can trust before cut-over",
    ],
  },
  {
    id: "arqtechops",
