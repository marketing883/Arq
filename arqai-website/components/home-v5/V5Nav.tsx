...
const ACCEL_ICONS: Record<string, React.ReactNode> = {
  ...
  arqbanker: <BankIcon />,
  arqforecast: <TrendIcon />,
  arqsupport: <HeadsetIcon />,
  arqdataq: <DatabaseIcon />,
...
const MENUS: Menu[] = [
  ...
  },
  {
    ...
    feature: { href: "/case-studies/tpa-blind-spot-assessment", image: `${A}/wqdffQW0WSkz5XQ7YchgqN2bDQ.jpeg`, tag: "Case study", title: "Undetected waste found, vendor rated compliant" },
  },
  {
    label: "Resources",
    links: [
