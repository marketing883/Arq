    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <motion.div
          ...
          className="relative w-full max-w-5xl max-h-[85vh] overflow-auto bg-white rounded-2xl shadow-2xl border border-gray-200"
        >
          {/* Header */}
          <div className="sticky top-0 z-10 flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gray-50 rounded-t-2xl">
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-[#d0f439] animate-pulse" />
